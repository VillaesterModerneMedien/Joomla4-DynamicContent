        ...
        $config->add('customizer', [
            ...
            'editor' => [
                ...
                'settings' => static::loadSettings() + [
                    ...
                    'toolbar1' => 'formatselect bold italic bullist numlist blockquote alignleft aligncenter alignright link insert strikethrough hr pastetext removeformat charmap outdent indent',
                ],
            ],
